...
# создание работника
create_restaurant_data = reqparse.RequestParser()
create_restaurant_data.add_argument('email', type=str, help='Требуется email для регистрации работника', required=True)


# create_user_data.add_argument('phone', type=str, help='Требуется телефон для регистрации', required=True)


def create_restaurant_validation(data):
...
delete_admin_data.add_argument('email', type=str, help='Требуется email для удаления работника', required=True)
